        ...
        <Fade bottom>
          <div className="w-full bg-gray-800 text-white">
            ...
            <div className="flex items-center justify-around py-4">
              <span>
                Copyright ©<span className="text-red-500"> GOSTO</span> all
                rights reserved. Powered by <br />
                <span className="text-red-500">Blueskytechco.</span>
              </span>
              <div className="flex items-center">
                <span>Social Media: </span>
                <div className="ml-2 flex gap-4">
                  <FaFacebookF className="hover:opa cursor-pointer opacity-50" />
